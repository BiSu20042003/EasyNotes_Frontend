...
const Sidebar = ({ open, setOpen }) => {
  ...
  return (
    <>
      {/* FIX: Force Tailwind to generate these classes */}
      <div className="hidden -translate-x-full translate-x-0"></div>
      ...
      >
        ...
        <div className="flex flex-col p-4 space-y-4">
          ...
          {!currUser ? (
            <Link to="/login" onClick={() => setOpen(false)} className="px-4 py-2 bg-green-600 text-white rounded-lg text-center">
              Login
            </Link>
          ) : (
            <button
